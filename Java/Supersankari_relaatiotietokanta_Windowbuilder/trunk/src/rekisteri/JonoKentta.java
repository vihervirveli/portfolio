...
public class JonoKentta extends PerusKentta {
	 ...
	 *
	 * @param kysymys
	 *            joka esitetään kenttää kysyttäessä.
	 ...
	 *            joka esitetään kenttää kysyttäessä.
	 * @param tarkistaja
	 *            tarkistajaluokka joka tarkistaa syötön oikeellisuuden
	 */
	...
	/**
	 * @param s
	 *            merkkijono joka asetetaan kentän arvoksi
	 ...
	 * @param o se toinen kentta johon verrataan
	 * @return kenttien suhteen toisiinsa
	 */
	@Override
