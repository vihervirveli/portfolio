...
public class Rekisteri {
	...
	public static void main(String[] args) {
		...
		try {
			...
			rekkari.lisaaAivanUusiKyky("J‰‰", "testit.txt");
			rekkari.lisaaAivanUusiKyky("Tuli", "testit.txt");
		...
		try {
			...
			String testit = "testit.txt";
			rekkari.lisaaSupis(battis, testit);
			rekkari.lisaaSupis(captis, testit);
			rekkari.lisaaSupis(iris, testit);
			rekkari.lisaaAivanUusiKyky("J‰‰", testit);
			rekkari.lisaaAivanUusiKyky("Tuli", testit);
			rekkari.lisaaAivanUusiKyky("Projektiilit", testit);
			rekkari.lisaaAivanUusiKyky("Taikuus", testit);
		...
		}
		{
			...
			String captis = "Captain America | Rogers Steve       | Stark Tony    | Brooklyn    |  2               ";
			String iris = "Iron Man        | Stark Tony         | Rogers Steve  | New York    |  3";
			rekkari.lisaaSupis(battis, "testit.txt");
			rekkari.lisaaSupis(captis, "testit.txt");
			rekkari.lisaaSupis(iris, "testit.txt");
	...
	public List<Supersankari> etsi(String hakuehto, int k) {
		return supikset.etsi(hakuehto, k);
	}
	...
	public void tallennaSupisJaKaverit(Supersankari supe, String tiedot) {
		supikset.tallennaSupisJaKaverit(supe, tiedot);
	}
	 ...
	 * </pre>
	 */
	public void lisaaAivanUusiKyky(String uudenKyvynNimi, String tiedostoNimi)
			throws SailoException {
		kyvyt.lisaaKyky(uudenKyvynNimi, tiedostoNimi);
	}
	 ...
	 * rekkari.lisaaSupis(supis1, "testit.txt");
	 * rekkari.lisaaSupis(supis2, "testit.txt");
	 * rekkari.lisaaSupis(supis1, "testit.txt");
	 ...
	 * </pre>
	 */
	public void lisaaSupis(String tiedot, String tiedostoNimi) {
		// if (tiedot.length() == 0)
		// return false; // turha tarkistus koska sielt‰ tulee jokatapauksessa
		// jotain
		supikset.lisaaSupis(tiedot, tiedostoNimi);
	 ...
	 * rekkari.lisaaSupis(supis, &quot;testit.txt&quot;);
	 * rekkari.lisaaKykySupikselle(&quot;Captain America&quot;, &quot;J‰‰&quot;, 300);
	 * </pre>
	 */
	public void lisaaKykySupikselle(String kenelle, String mikaKyky,
		...
		parit.lisaaPari(supisId, kykyId, voimakkuus, null);
	...
	/**
	 * Palauttaa supen id:n perusteella listan niist‰ kyvyist‰ mit‰ sill‰ ei ole
	 *
	 * @param id
	 *            supen id jonka kyvyista lista halutaan
	 * @return listan kyvyista mit‰ supella ei ole
	 */
	public List<Integer> eiSupiksenKyvyt(int supiksenId) {
		return parit.eiSupiksenKyvyt(annaKyvyt(), supiksenId);
	}
	...
	// * Rekisteri rekkari = new Rekisteri();
	// * String supis =
	// "Captain America | Rogers Steve       | Stark Tony    | Brooklyn    |  2               ";
	// * rekkari.lisaaSupis(supis, "testit.txt");
	// * rekkari.lisaaKykySupikselle("Captain America","J‰‰", 300);
