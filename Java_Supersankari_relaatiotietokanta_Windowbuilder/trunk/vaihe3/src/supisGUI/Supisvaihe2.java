	...
	public Supisvaihe2() {
		...
		list.addMouseListener(new MouseAdapter() {
			...
			public void mouseClicked(MouseEvent arg0) {
				JOptionPane.showConfirmDialog(null,
						"Kun ohjelma toimii voit klikata yhtä nimeä ja saada sen tiedot. Et vielä.", "Näe supersankarin tiedot", JOptionPane.OK_OPTION);
			}
		});
		...
		tableKyvyt.addMouseListener(new MouseAdapter() {
			...
			public void mouseClicked(MouseEvent e) {
				JOptionPane.showConfirmDialog(null,
						"Kun ohjelma toimii voit muokata kykytietoja. Et vielä.", "Muokaa kyvyn tietoja", JOptionPane.OK_OPTION);
		...
		listVahvemmat.addMouseListener(new MouseAdapter() {
			...
			public void mouseClicked(MouseEvent arg0) {
				JOptionPane.showConfirmDialog(null,
						"Kun ohjelma toimii voit klikata listasta supersankaria ja nähdä sen tiedot. Et vielä.", "Näe vahvemman sankarin tiedot", JOptionPane.OK_OPTION);
