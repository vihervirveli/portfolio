...
public class Supis extends JFrame {
		...
		list.addMouseListener(new MouseAdapter() {
			...
			public void mouseClicked(MouseEvent arg0) {
				JOptionPane
						.showMessageDialog(
								null,
								"Kun ohjelma toimii voit klikata yhtä nimeä ja saada sen tiedot. Et vielä.",
								"Tba", JOptionPane.INFORMATION_MESSAGE);
    ...
    /**Luo uuden ja
     * Luo uuden ja laittaa SupisOhje-dialogin näkyviin
     */
    protected void ohje() {
    ...
    /**Luo uuden ja
     * Luo uuden ja laittaa SupisAbout-dialogin näkyviin
     */
