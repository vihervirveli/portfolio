...
//		private final JMenuBar menuBar = new JMenuBar();
		...
		private final JMenuItem menuItem_1 = new JMenuItem("Valitse supersankari...");
		...
		private final JMenuItem menuItem_4 = new JMenuItem("Muokkaa supersankarin tietoja...");
		private final JMenuItem menuItem_5 = new JMenuItem("Muokkaa kyvyn tietoja...");
		private final JMenuItem menuItem_6 = new JMenuItem("Lis\u00E4\u00E4 uusi supersankari");
		private final JMenuItem menuItem_7 = new JMenuItem("Lis\u00E4\u00E4 uusi kyky");
		...
		private final JMenuItem menuItem_10 = new JMenuItem("K\u00E4ytt\u00F6ohjeet");
		private final JMenuItem menuItem_11 = new JMenuItem("About Batmanin supersankarirekisteri");
	...
	public ValikkoEdit() {
		...
		menuItem.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent arg0) {
				JOptionPane.showMessageDialog(null, "Tallentaa tiedot tietokantaan. Ei vielä, tosin.",
